      ...
      <div className="grid">
        <div className="card">
          ...
          <p className="card-desc">
            ...
            rejected. This is the one action that triggers GenLayer
            consensus — validators fetch the spec and deliverable and judge
            conformance.
          </p>
          <div className="field">
            <label>Job ID</label>
          ...
          <div className="field">
            <label>Deliverable hash / URL</label>
            <input
          ...
          <button
            ...
            onClick={async () => {
              try {
                ...
                const addr = requireWallet();
                const { hash } = await fileClaim(addr, claimJobId, deliverableHash);
